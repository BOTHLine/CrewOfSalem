...
namespace CrewOfSalem.Roles.Abilities
{
    public class AbilityForge : AbilityDuration
    {
        ...
        public void Forge()
        {
            ...
            owner.Owner.myRend.material.SetColor(ShaderBackColor, Palette.ShadowColors[currentSample.Data.ColorId]);
            owner.Owner.myRend.material.SetColor(ShaderBodyColor, Palette.PlayerColors[currentSample.Data.ColorId]);
