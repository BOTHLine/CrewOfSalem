...
namespace CrewOfSalem
{
    ...
    public class Main : BasePlugin
    {
        ...
        private static KeyValuePair<Type, CustomNumberOption> CreateRoleCooldownOption<T>(string actionName,
        ...
        private static KeyValuePair<Type, CustomNumberOption> CreateRoleDurationOption<T>(string actionName,
            float value = 15F, float min = 5F, float max = 30F, float increment = 2.5F) where T : RoleGeneric<T>, new()
        {
            return new KeyValuePair<Type, CustomNumberOption>(typeof(T),
